    ...
    <div class="card mt-3">
      ...
      <div class="card-body">
        <div class="form-group">
          <input type="text" class="form-control" ref="post_title" placeholder="Judul" />
        </div>
        <div class="form-group">
          <input type="text" class="form-control" ref="post_description" placeholder="Deskripsi" />
        </div>
        <div class="form-group">
          <input type="text" class="form-control" ref="post_selesai" placeholder="Status Pengerjaan (isi dengan true / false)" />
        </div>
  ...
  methods: {
    ...
    async postData() {
      const postData = {
        ...
        selesai: this.$refs.post_selesai.value,
      };
      try {
